      ...
      <SafeAreaView style={{ flex: 1, backgroundColor: "transparent", padding: 10 }}>
        ...
        {disease === "FLU" && (
          <ScrollView style={styles.container}>
            ...
            <Text style={styles.paragraph}>
              ...
              over-the-counter medications, but for some people flu can be
              severe.
            </Text>
            ...
            <Text style={styles.paragraph}>
              ...
              virus attacks the respiratory system, leading to inflammation,
              body aches, and fatigue. Most people recover in about a week, but
            ...
            <Text style={styles.paragraph}>
              ...
              rest. Antihistamines, decongestants, pain relievers, drinking
              plenty of fluids, and inhaling steam may help ease symptoms. For
              people at risk for complications and those with severe symptoms,
              antiviral medications such as oseltamivir (Tamiflu), baloxavir
              (Xofluza), peramivir (Rapivab), or zanamivir (Relenza) may help
              reduce the duration of symptoms, shorten the illness, and prevent
              complications if taken early.
            </Text>
            <TouchableOpacity
              onPress={() =>
                Linking.openURL(
            ...
            <Text style={styles.bulletPoint2}>
              <Entypo name="dot-single" size={16} color="black" /> Wearing a
              mask in crowded places during flu season.
            </Text>
            <Text style={styles.bulletPoint2}>
              ...
              {uType === "adult" && (
                <ScrollView style={{ padding: 10 }}>
                  ...
                  >
                    ...
                    <Text style={styles.bulletPoint}>
                      <Octicons name="dot-fill" size={14} color="black" />{" "}
                      Severe dizziness, confusion, or trouble staying awake
                    </Text>
                    <Text style={styles.bulletPoint}>
                      <Octicons name="dot-fill" size={14} color="black" />{" "}
        ...
        {disease === "COLD" && (
          <ScrollView style={styles.container}>
            ...
            <Text style={styles.paragraph}>
              Because more than 200 viruses cause colds, and new ones develop
              all the time, the body can't build immunity to colds. Colds spread
            ...
            <Text style={styles.sectionTitle}>Treatment</Text>
            <Text style={styles.paragraph}>
              Colds usually get better on their own in a few days.
              Antihistamines, decongestants, pain relievers, drinking plenty of
              fluids, and breathing in steam may help ease symptoms.
            </Text>
            <TouchableOpacity
              onPress={() =>
                Linking.openURL(
            ...
            <Text style={styles.bulletPoint3}>
              <Entypo name="dot-single" size={16} color="black" />
              Keeping your hands away from your face, especially your eyes,
              nose, and mouth.
            </Text>
            <Text style={styles.bulletPoint3}>
              <Entypo name="dot-single" size={16} color="black" />
              ...
              {uType === "child" && (
                <ScrollView style={{ padding: 10, marginBottom: 5 }}>
                  ...
                  >
                    <Text style={styles.bulletPoint}>
                      <Octicons name="dot-fill" size={14} color="black" /> Fever
                      of 100.4 degrees Fahrenheit (38 degrees Celsius) in
                      newborns up to 12 weeks.
                    </Text>
                    <Text style={styles.bulletPoint}>
                      <Octicons name="dot-fill" size={14} color="black" />{" "}
                      Rising fever or fever lasting more than two days in a
                      child of any age.
                    </Text>
                    <Text style={styles.bulletPoint}>
                      <Octicons name="dot-fill" size={14} color="black" />{" "}
                ...
                <ScrollView style={{ padding: 10 }}>
                  ...
                  >
                    ...
                    <Text style={styles.bulletPoint}>
                      ...
                      Celsius) that lasts more than three days.
                    </Text>
                    <Text style={styles.bulletPoint}>
                      <Octicons name="dot-fill" size={14} color="black" /> Fever
            ...
            <Text style={styles.paragraph}>
              Most often, you don't need medical care for a common cold. But
              seek medical attention if you have a fever above 102 degrees
              Fahrenheit, chills, vomiting, shortness of breath, stomach pain,
              or don't get better after 10 days.
            </Text>
            <Text style={styles.paragraph}>
              For young children, elderly, pregnant women, or people with
              weakened immune systems, it's best to consult a doctor early.
            </Text>
        ...
        {disease === "COVID" && (
          <ScrollView style={styles.container}>
            ...
            <Text style={styles.paragraph}>
              ...
              Congestion/runny nose, Loss of smell or taste, Nausea, and
              Diarrhea.
            </Text>
            ...
            <Text style={styles.paragraph}>
              ...
              coughs, sneezes, or talks. It can also spread by touching surfaces
            ...
            <Text style={styles.sectionTitle}>Treatment</Text>
            <Text style={styles.paragraph}>
              There is currently no specific antiviral treatment for COVID-19,
              but treatments are available to help manage symptoms.
              Hospitalization may be required for severe cases, particularly for
              those with breathing difficulties or pneumonia.
            </Text>
            ...
            <Text style={styles.paragraph}>
              If you are experiencing symptoms of COVID-19, it is recommended
              to:
            </Text>
            <Text style={styles.bulletPoint4}>
              <Entypo name="dot-single" size={16} color="black" />
            ...
            <Text style={styles.bulletPoint4}>
              ...
              Adhere to local health protocols regarding quarantine or
              isolation.
            </Text>
            ...
            <Text style={styles.bulletPoint4}>
              ...
              Avoid touching your eyes, nose, and mouth with your unwashed
              hands.
            </Text>
            <Text style={styles.bulletPoint4}>
              <Entypo name="dot-single" size={16} color="black" />
            ...
            <Text style={styles.paragraph}>
              ...
              adults (ages 65 and older), People with underlying health
              conditions such as diabetes, heart disease, or respiratory
              illnesses, and Pregnant women. Seek immediate medical care if you
              experience:
            </Text>
            <View
              style={{
            ...
            >
              ...
              <Text style={styles.bulletPoint1}>
                <Octicons name="dot-fill" size={14} color="black" /> Confusion
            ...
            <Text style={styles.paragraph}>
              ...
              have recovered from the acute phase of the illness. This is known
              as Long COVID or Post-COVID Conditions, and it can last for weeks
              or months. Common symptoms of Long COVID include:
            </Text>
            <View
              style={{
                justifyContent: "center",
            ...
            >
              ...
              <Text style={styles.bulletPoint1}>
                <Octicons name="dot-fill" size={14} color="black" /> Shortness
                of breath
              </Text>
              <Text style={styles.bulletPoint1}>
            ...
            <Text style={styles.paragraph}>
              Recovery time can vary based on the severity of the infection,
              with people recovering in about 2 weeks for mild cases but
              potentially taking 4-6 weeks or longer for severe cases.
            </Text>
          </ScrollView>
        )}
      </SafeAreaView>
